...
namespace Bloxcrosoft
{
    public class Bootstrapper
    {
        ...
        public async Task Run()
        {
            ...
            try
            {
                Mutex.OpenExisting("Bloxcrosoft_SingletonMutex").Close();
                App.Logger.WriteLine(LOG_IDENT, "Bloxcrosoft_SingletonMutex mutex exists, waiting...");
            ...
            await using var mutex = new AsyncMutex(true, "Bloxcrosoft_SingletonMutex");
        ...
        private async Task StartRoblox()
        {
            ...
            // keep bloxcrosoft open in the background if needed
            if (!shouldWait)
                return;
        ...
        public static void CheckInstall()
        {
            ...
            // but then people who have Bloxcrosoft v1.0.0 installed won't have this without a reinstall
            ...
            {
                // v2.0.0 - rebadge configuration menu as just "Bloxcrosoft Menu"
        ...
        private async Task CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Bloxcrosoft instance running, aborting update check");
                return;
            }
            ...
            SetStatus(Resources.Strings.Bootstrapper_Status_UpgradingBloxcrosoft);
        ...
        private void Uninstall()
        {
            ...
            // if the folder we're installed to does not end with "Bloxcrosoft", we're installed to a user-selected folder
