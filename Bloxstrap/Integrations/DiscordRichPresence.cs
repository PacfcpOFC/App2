...
namespace Bloxcrosoft.Integrations
{
    public class DiscordRichPresence : IDisposable
    {
        ...
        public void ProcessRPCMessage(Message message)
        {
            ...
            Models.BloxcrosoftRPC.RichPresence? presenceData;
            
            // a lot of repeated code here, could this somehow be cleaned up?

            try
            {
                presenceData = message.Data.Deserialize<Models.BloxcrosoftRPC.RichPresence>();
            }
            catch (Exception)
            {
        ...
        public async Task<bool> SetCurrentGame()
        {
            ...
            // this is used for configuration from BloxcrosoftRPC
