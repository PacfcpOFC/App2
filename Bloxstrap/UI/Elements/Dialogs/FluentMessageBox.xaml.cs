...
using Bloxcrosoft.UI.Utility;

namespace Bloxcrosoft.UI.Elements.Dialogs
{
        ...
        private static string GetTextForResult(MessageBoxResult result)
        {
            switch (result)
            {
                case MessageBoxResult.OK:
                    return Bloxcrosoft.Resources.Strings.Common_OK;
                case MessageBoxResult.Cancel:
                    return Bloxcrosoft.Resources.Strings.Common_Cancel;
                case MessageBoxResult.Yes:
                    return Bloxcrosoft.Resources.Strings.Common_Yes;
                case MessageBoxResult.No:
                    return Bloxcrosoft.Resources.Strings.Common_No;
                default:
                    Debug.Assert(false);
