...
namespace Bloxcrosoft.Extensions
{
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconBloxcrosoft;
            }

            return icon switch
            {
                BootstrapperIcon.IconBloxcrosoft => Properties.Resources.IconBloxcrosoft,
                ...
                _ => Properties.Resources.IconBloxcrosoft
            };
        }
    }
}
