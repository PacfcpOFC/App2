...
namespace Bloxcrosoft
{
    ...
    {
        public const string ProjectName = "Bloxcrosoft";
        public const string ProjectRepository = "pizzaboxer/bloxcrosoft";
                ...
                else
                {
                    if (Process.GetProcessesByName(ProjectName).Length > 1 && !LaunchSettings.IsQuiet)
                        Frontend.ShowMessageBox(
                            Bloxcrosoft.Resources.Strings.Menu_AlreadyRunning, 
